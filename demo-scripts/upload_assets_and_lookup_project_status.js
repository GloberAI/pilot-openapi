/**
 * This script demonstrates the complete workflow for interacting with the Glober API:
 * 
 * Step 1: Authentication
 * - Login using email and password to obtain an access token
 * - Usage: node script.js PASSWORD=yourpassword
 * 
 * Step 2: Project Creation
 * - Creates a new project with specified configurations
 * - Uses createProject() function with predefined settings for Apple App Store localization
 * 
 * Step 3: Asset Management
 * - Uploads multiple assets (images/text) to the created project
 * - Supports both text and file-based assets
 * - Uses uploadAsset() function for individual asset uploads
 * 
 * Step 4: Project Status Tracking
 * - Retrieves and displays the current status of the project
 * - Monitors project progress after asset uploads
 * 
 * Dependencies:
...
if (!passwordArg) {
  console.error('Error: Password is required. Usage: node upload_assets_and_lookup_project_status.js PASSWORD=yourpassword');
  process.exit(1);
}
